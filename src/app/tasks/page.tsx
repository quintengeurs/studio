        ...
        <Tabs defaultValue="active" className="w-full">
          <TabsList className="mb-6">
            ...
            <TabsTrigger value="automation" className="flex items-center gap-2 relative">
              <Zap className="h-4 w-4" /> Automation Hub
              {proposedTasks.length > 0 && (
                <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-orange-500 text-[10px] text-white font-bold shadow-sm animate-pulse">
          ...
          <TabsContent value="automation">
            <div className="grid gap-4">
              <div className="flex flex-col gap-1 mb-2">
                ...
                <p className="text-xs text-muted-foreground">Review and approve tasks generated by the Smart Tasking engine based on live data.</p>
              </div>
              ...
              {proposedTasks.length > 0 ? (
                ...
                <div className="py-20 text-center border-2 border-dashed rounded-3xl space-y-4 bg-muted/10">
                  ...
                  <div>
                    <p className="text-lg font-bold text-muted-foreground">No pending suggestions</p>
                    <p className="text-sm text-muted-foreground">The Smart Tasking engine is currently quiet. Check back after the next weather update!</p>
                  </div>
                </div>
              )}
            </div>
